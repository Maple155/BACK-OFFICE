...
<body>
    ...
    <h2> POST </h2>
    <form action="/framework/test1" method="POST">
    ...
    <h2> GET </h2>
    <form action="/framework/test1" method="GET">
    ...
    <h2> Request Mapping POST </h2>
    <form action="/framework/test1/requestMapping" method="POST">
    ...
    <h2> Request Mapping GET </h2>
    <form action="/framework/test1/requestMapping" method="GET">
